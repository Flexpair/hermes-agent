...
def _prepare_checkout_for_update(
    ...
    # zero/nonzero gate is still sound; recover its count from the owning GitHub repository.
    ...
    if commit_count > 0 and apply_is_shallow:
        counted = _check.compare_shallow_revisions(git_cmd, _m().PROJECT_ROOT, target_ref)
