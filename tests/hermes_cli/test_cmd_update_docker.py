...
# This test deliberately supplies a standalone temp Docker project, not a
# Hermes checkout. The owning-install guard is unrelated to this admission gate.
@pytest.fixture(autouse=True)
def _no_owning_install_retarget(monkeypatch):
